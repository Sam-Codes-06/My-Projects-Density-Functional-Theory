...
plot [:][-3:3] \
     'Fe.dos.dat' u ($1-Efermi):2     notit w filledcurve y1=0.0 lt 1, \
     'Fe.dos.dat' u ($1-Efermi):2     title "majority spin" w l lt 1 lw 2, \
     \
     'Fe.dos.dat' u ($1-Efermi):(-$3) notit w filledcurve y1=0.0 lt 2, \
     'Fe.dos.dat' u ($1-Efermi):(-$3) title "minority spin" w l lt 2 lw 2
pause -1
